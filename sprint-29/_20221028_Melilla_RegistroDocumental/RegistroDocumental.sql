...
SET @p_params= '<NodoXML><LI><FecDesde>2022-10-01</FecDesde><FecHasta>2022-10-15</FecHasta></LI></NodoXML>'
/*
...
*/
	...
	WITH PK AS(
	SELECT R.regEntNum
	, R.regEntRegEntTipCod
	, CN= COUNT(E.regEntArcId)
	, FICHEROS = STRING_AGG(E.regEntArcFicheroNombre , ', ')
	...
	, [Texto]			= R.regEntTexto
	, [Num.Ficheros]	= PK.CN
	, [Ficheros]		= PK.FICHEROS
	FROM PK 
	INNER JOIN dbo.registroEntradas AS R
	ON  R.regEntNum = PK.regEntNum
	AND R.regEntRegEntTipCod = PK.regEntRegEntTipCod
