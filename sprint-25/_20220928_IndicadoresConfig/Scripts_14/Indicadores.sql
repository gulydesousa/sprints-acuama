...
VALUES ('000/900',	'Indicadores: Acuama', 'Consulta de Indicadores', 3, '[InformesExcel].[Indicadores]', '000', 'Informe preliminar para la consulta de los indicadores: Mensuales y Semanales a la fecha indicada como parámetro', NULL);
...
SET @p_params= '<NodoXML><LI><Fecha>20220205</Fecha></LI></NodoXML>';
...
AS
	...
	DECLARE @params TABLE (Fecha DATE NULL, fInforme DATETIME);
	...
	INNER JOIN dbo.parametros AS P
	ON P.pgsclave = 'EXPLOTACION'
	WHERE (P.pgsvalor = 'Guadalajara' AND R.gredes='Reclamación');
