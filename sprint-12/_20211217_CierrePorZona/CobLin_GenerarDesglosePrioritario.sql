...
AS
	...
	SELECT ROW_NUMBER() OVER(ORDER BY (CASE WHEN S.svcOrgCod IS NULL THEN S.svccod ELSE 9999 END) ASC, S.svccod) AS numRegistro
			, FL.fclNumLinea
			, FL.fclTotal
			, FL.fclTrfSvCod
			, FL.fclTrfCod
	...
	ORDER BY (CASE WHEN S.svcOrgCod IS NULL THEN S.svccod ELSE 9999 END) ASC, S.svccod
