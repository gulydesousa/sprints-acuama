...
AS
	...
	BEGIN TRANSACTION
		...
		--Sale en el TraceError.log si hay fallo
	 	PRINT FORMATMESSAGE('*** CobLin_Insert %i, %i, %i, %i, %s, %i %i, %i, %i', @cblScd, @cblPpag, @cblNum, @cblFacCod, @cblPer, @cblFacVersion, CAST(@cblImporte AS INT), @cblLin, CAST(@servicioLiquidado AS INT))
		--**************************************
