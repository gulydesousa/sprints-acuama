...
--Tarea Aplicar consumos comunitarios por zona
--PARAMS: @ctrZonCod=3, @facPerCod=202201, @usarYActualizarFacCtrVersion=1, @ctrRaizCod=(null)
EXEC [dbo].[Tasks_Facturas_AplicarConsumosComunitarios] @ctrZonCod, @facPerCod, @usarYActualizarFacCtrVersion, NULL, @tskUser, @tskType, @tskNumber, @arbolesComunitariosAfectados OUT;
