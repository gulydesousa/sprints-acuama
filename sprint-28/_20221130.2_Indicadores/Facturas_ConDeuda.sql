...
DECLARE @usos VARCHAR(MAX) = '1, 2, 3, 4, 5, 6';
DECLARE @tipoSalida TINYINT = 3;
...
BEGIN TRY
	...
	GROUP BY F.facCod, F.facPerCod, F.facCtrCod, F.facVersion, CL.cblScd, CL.cblPpag, CL.cblNum, CL.cblLin
	...
	BEGIN
		SELECT @result = SUM(facDeuda) FROM #RESULT;
	END
