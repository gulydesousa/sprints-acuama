...
SET @p_params= '<NodoXML><LI><Fecha>20210301</Fecha><Semanas></Semanas></LI></NodoXML>';
...
AS
	...
	FROM Indicadores.fAplicarParametros (@Fecha
									   ...
									   , @RECLAMACION
									   , @INSPECCIONES)
	WHERE indPeriodicidad = 'S' OR indPeriodicidad = 'F' OR  indPeriodicidad=@Mensual OR (@Mensual='M' AND indPeriodicidad='A');
