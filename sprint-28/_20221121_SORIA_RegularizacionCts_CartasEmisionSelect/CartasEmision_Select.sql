...
*/
ALTER PROCEDURE [dbo].[CartasEmision_Select]
...
AS 
	...
	FROM (
			...
			FROM (
					...
					, deuda = IIF(ROUND(ISNULL(importeFacturado,0), 2) > ISNULL(importeCobrado,0) + 1, 1, 0) --(+1) para evitar céntimos de descuadre (AVG, SORIA...)	
					FROM CONTRATOS C
