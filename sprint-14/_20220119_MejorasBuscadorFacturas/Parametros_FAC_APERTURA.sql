CREATE PROCEDURE Trabajo.Parametros_FAC_APERTURA(@version VARCHAR(25))
AS
	SET NOCOUNT ON;
	
	DECLARE @valorON BIT = IIF(@version>='2.1', 1, 0);
	...
	VALUES(@CLAVE
	, 'Versión de la apertura de facturación:'+ CHAR(10)+ 
	'1.0: Inicial '+ CHAR(10)+
	'2.0: Begin Tran por factura'+ CHAR(10)+   
	'2.0.1: Bug concurrencia cobros-remesas'+ CHAR(10)+  
	'2.1: Mejorar Buscador de facturas '+ CHAR(10)+
	'2.1.1: No aplaza triggers Remesas'
	, 2, @version, 0, 1, 0);


	--[02]Actualizar facTotales	
	IF (@valorON=1 AND @VALOR<'2.1')
	BEGIN
