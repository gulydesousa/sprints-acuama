...
Para borrar todo lo referente a una remesa
	...
	FROM facturas 
	WHERE facNumeroRemesa=65
	
	• @usuarioRemesa
	SELECT DISTINCT cobUsr 
	FROM cobros 
	WHERE cobOrigen='remesa' AND cobConcepto LIKE '%65%'
*/

--3812
/*
DECLARE @numeroRemesa INT = 65
DECLARE @fechaRemesa DATETIME = '20220110 10:17:04.157'
DECLARE @usuarioRemesa VARCHAR(20)= 'MMATEO'
