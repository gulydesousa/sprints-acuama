CREATE FUNCTION [dbo].[fContratos_ContadoresInstalados] (@fecha DATETIME = NULL)
	RETURNS TABLE 
	AS
	...
	ON ctcCtr = ctrcod
		...
		AND ctcOperacion = 'I'
		--ctcFec: Se comenta condicion antes incluida (30/04/21) "Se incluyen contadores que no les aparece el calibre" 
