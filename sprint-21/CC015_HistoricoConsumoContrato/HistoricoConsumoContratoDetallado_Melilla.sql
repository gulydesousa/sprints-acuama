...
EXEC [ReportingServices].[HistoricoConsumoContratoDetallado_Melilla] @codigoContratoD, @codigoContratoH, @fechaD, @fechaH, @periodoD, @periodoH, @repLegal, @zonaD, @zonaH
*/


ALTER PROCEDURE [ReportingServices].[HistoricoConsumoContratoDetallado_Melilla]
@codigoContratoD INT,
@codigoContratoH INT,
@fechaD DATE,
@fechaH DATE,
