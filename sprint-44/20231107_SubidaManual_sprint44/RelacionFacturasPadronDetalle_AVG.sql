...
ALTER PROCEDURE [ReportingServices].[RelacionFacturasPadronDetalle_AVG]
...
BEGIN TRY
	...
	SELECT [codigo] = F.facCod, [contrato] = F.facCtrCod, [zona] = F.facZonCod, [version] = F.facversion, [periodo]= F.facpercod
		 ...
		 , [consumo] = FL.consumo
		 , [diametro] = ISNULL(CC.conDiametro, V.Calibre)
	...
	--***********************
	LEFT JOIN dbo.vContratosServicio_CuotaFijaAVG AS V
