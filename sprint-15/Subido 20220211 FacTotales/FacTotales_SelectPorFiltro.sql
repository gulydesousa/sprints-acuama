ALTER PROCEDURE dbo.FacTotales_SelectPorFiltro
...
AS 
	...
	WITH FACS AS (
	--Como sincronizamos todas las versiones, evitamos enviar duplicados RN=1,
	--Si no hacemos esto nos va a totalizar mal la factura
	SELECT facCod
		 , facPerCod
		 , facCtrCod
		 , facVersion
	...
	--Todas las versiones de la factura enviada
