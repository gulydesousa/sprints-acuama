--EXEC ReportingServices.Informe_MELILLA_CA013_EmisionNotificaciones @tipo=N'lectura',@cartaTipo=7,@periodo=N'202104'--,@contratoD=1000,@contratoH=2500,@zonaD=NULL,@zonaH=NULL,@ruta1D=NULL,@ruta1H=NULL,@ruta2D=NULL,@ruta2H=NULL,@ruta3D=NULL,@ruta3H=NULL,@ruta4D=NULL,@ruta4H=NULL,@ruta5D=NULL,@ruta5H=NULL,@ruta6D=NULL,@ruta6H=NULL,@filtro=N' WHERE inlcod=11',@forzarTipoCarta=0,@legal=N'Indiferente',@listado=N'1',@tieneEmail=1

CREATE PROCEDURE [ReportingServices].[Informe_MELILLA_CA013_EmisionNotificaciones]
(
	@tipo VARCHAR(20),
	@cartaTipo INT,
	@periodo VARCHAR(6),
