/*
DECLARE @tipo VARCHAR(20)='Inspeccion',--Tipo Incidencia (Lectura, Inspeccion),
@cartaTipo INT=20,
@periodo VARCHAR(6)='202203',
@contratoD INT = NULL,
@contratoH INT = NULL,
...
@filtro VARCHAR(500) = ' WHERE inlcod=67',
...
--EXEC ReportingServices.Informe_MELILLA_CA013_EmisionNotificaciones @tipo=N'',@cartaTipo=20,@periodo=N'202303',@tieneEmail=1, @filtro='', @orden='', @excluirNoEmision=0;
